...
const Input = ({placeholder, name,type,value,handleChange}) => (
  ...
  className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none white-glassmorpism"
  />
      ...
      <div className="flex mf:flex-row items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the crypto world. Buy and sell cryptocurrencies easily on KRIPTz
          </p>
        ...
        <div className="flex flex-col flex-1 items-center justify-center w-full m:mt-0 mt-10">
