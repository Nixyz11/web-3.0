  ...
  return (
    <div className='w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer'>
      ...
      <p className='text-white text-sm text-center'>Come join us</p>      
        <p className='text-white text-sm text-center'>Info@ctypto.com</p>
      </div>
      <div className='sm:w-[90% w-full h-[0.25px] bg-gray-499 mt-5]'/>
      <div className='sm:w-[90%] w-full flex justify-between items-center mt-3'>
      <p className='text-white text-sm text-center'>Crypto bro</p>
      <p className='text-white text-sm text-center'>All rights not reserved</p>
      </div>
    </div>
  )
}
